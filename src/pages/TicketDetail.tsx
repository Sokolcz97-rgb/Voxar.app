          ...
          <>
            ...
            <Card className="glass border-border p-5 mb-4">
              <div className="flex items-center gap-3 mb-3">
                <UserAvatar url={author?.avatar_url} name={author?.display_name || author?.username} userId={(author as any)?.user_id} className="h-9 w-9" />
                <div>
            ...
            <div className="space-y-3">
              {replies.map((r) => (
                <Card key={r.id} className={`glass p-5 animate-fade-in ${
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <UserAvatar url={r.author?.avatar_url} name={r.author?.display_name || r.author?.username} userId={(r.author as any)?.user_id} className="h-9 w-9" />
